...
class FPropertyWindow
{
  ...
  private:
    ...
    void DrawBillboardComponentDetails(class UBillboardComponent *BillboardComponent, FEditorEngine *Engine);
    void DrawDecalComponentDetails(class UDecalComponent *DecalComponent, FEditorEngine *Engine);
    bool DrawVector3Control(const char *Label, const FVector &Value, FVector &OutValue, float Speed,
                            const char *Format);
